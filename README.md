...
- 👁️ **Trou « en forme d'œil »** : hypothèse privilégiée = **vestige du dispositif défensif** (église-refuge). L'exposé HÉRAGE (d'après la thèse de Ph. Durand) **atteste** la fortification du XIVe s. *« en surélevant les murs, en condamnant les fenêtres et en ouvrant des meurtrières »* (toit rehaussé → comble-refuge, trémie de hissage/surveillance ; système supprimé par Boeswillwald). À confirmer dans le comble.
