# Crédits, sources et licences des images

Règle suivie : **seules les images librement réutilisables** (domaine public /
Creative Commons / Licence ouverte) sont **téléchargées** dans `images/`. Les
documents **sous droits réservés** (clichés de laboratoire, photothèques) ne sont
**pas redistribués** : ils sont **liés** ci-dessous, avec attribution.
...
## 2. Documents NON redistribués (liens + attribution)

### 2.1 Manuscrits enluminés des *Chroniques* de Froissart
Miniatures du **combat de Lussac / mort de Chandos** et scènes de la guerre de Cent
Ans. Nombreux manuscrits BnF (Gruuthuse, Fr 2643-2646, Fr 2663-2664…), souvent
**domaine public** mais numérisations soumises aux conditions des institutions.
- Catégorie Commons : <https://commons.wikimedia.org/wiki/Category:Chroniques_de_Froissart_-_BNF_Fr2663-2664>
- BnF Essentiels (Froissart, *Chroniques*) : <https://essentiels.bnf.fr>

### 2.2 Base ArmmA (SAPRAT / CNRS / EPHE / Univ. Poitiers) — © ArmmA
Page : <https://armma.saprat.fr/monument/sarcophage-morthemer-valdivienne/>
- **Plan de l'église** (relevé *Durand, 1979-1980*, pl. I) :
...
### 2.3 POP — Plateforme Ouverte du Patrimoine (Licence ouverte Etalab 2.0*)
*Certaines photos restent « © Monuments historiques » : vérifier au cas par cas.*
- Château (Mérimée **PA00105752**) : <https://pop.culture.gouv.fr/notice/merimee/PA00105752>
- Collégiale Notre-Dame (Inventaire **IA00045380**) : <https://pop.culture.gouv.fr/notice/merimee/IA00045380>
- Monument sépulcral de Jean Chandos (Palissy **PM86000321**) : <https://pop.culture.gouv.fr/notice/palissy/PM86000321>

### 2.4 Gravures, plans d'époque & cartes postales (accès / droits variables)
- *Congrès archéologique de France*, **Poitiers 1843**, et **Beauchet-Filleau** —
  numérisés sur **Gallica** (<https://gallica.bnf.fr>) et **Internet Archive**.
