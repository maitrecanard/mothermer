# Morthemer — Recherche historique et archéologique

> **Mission.** Reconstituer l'histoire du village médiéval de **Morthemer**
> (aujourd'hui commune de **Valdivienne**, Vienne, 86) **depuis l'an 900**, à partir
> des écrits, récits, archives et images disponibles, autour des quatre objets du
> cahier des charges : la **tour de Cognac**, l'**église**, le **trou « en forme
> d'œil »** du plafond (à l'opposé du clocher), et le **château**.
>
> *Posture : historien-archéologue médiéviste. Chaque fait est rattaché à une source
> (§ 10). Les points incertains ou débattus sont signalés — la rigueur prime sur le
> romanesque. Les écrits d'époque sont rassemblés dans [`TEXTES-ET-ECRITS.md`](TEXTES-ET-ECRITS.md).*
...
4. Le château
5. L'église (et l'imbrication église/château)
6. La tour de Cognac
7. Le mystère du « trou en forme d'œil »
8. Jean Chandos, Froissart et les légendes
9. Iconographie (images libres + manuscrits, plans, gravures)
...
Morthemer est un ancien village et **chef-lieu de châtellenie** du Poitou, sur un
promontoire dominant la rivière **la Dive**, à l'est de Poitiers. Il fait partie de
la commune de **Valdivienne**, née en **1969** de la fusion de Morthemer,
Salles-en-Toulon et Saint-Martin-la-Rivière (La Chapelle-Morthemer rejointe dans les
années 1970).

**Étymologie.** Attesté *Mortemarum* (1077), *Mortemer* (1164), *Morthomer* (1478) :
composé **« Morte- »** (eau morte/stagnante) **+ « -mer »** (latin *mare*, eau
...
| **1978 / 1982-1983** | **Découverte** puis **restauration** des peintures de la crypte. |
| **14 mai 2008** | **Inscription MH de l'ensemble** du château (PA00105752). |
...
**Donjon.** Tour **quadrangulaire de cinq niveaux**, **tourelles-contreforts sur
trois angles** et **tour en saillie sur le quatrième**, ressaut à l'angle sud-est,
...
l'intervention, « le donjon n'existerait plus ». Acquis par le **baron de
Soubeyran** (1844), restauré v. **1865** par **Boeswillwald** : la silhouette
« médiévale » actuelle est **en partie une recomposition du XIXe s.** (faux
mâchicoulis « créés de toutes pièces »).

**Protection.** Donjon **inscrit 1927**, ensemble **2008** (PA00105752). Propriété
**privée** (ne se visite pas). Coord. : 46° 28′ 28,9″ N, 0° 36′ 44,4″ E.

---

## 5. L'église (et l'imbrication église/château)

**Datation.** Édifice **roman des XIe–XIIe s.** : chevet et **crypte** (2ᵉ moitié
XIe s.) ; **transept, nef, clocher** remaniés (gothique) — datés de la **fin du
XIIe s.** par l'Inventaire, de **1230-1250** par ArmmA. **Collégiale** dès les
années 1220 ; **fortifiée au XIVe s.**

**Plan.** Croix latine, nef de **quatre à cinq travées**, transept asymétrique,
...
Le **grand portail ouest a été muré** ; l'accès se fait au **nord**, le long du
chevet. Une **tribune** permettait au seigneur et à sa garnison de suivre la messe
**à part**. La **crypte** servait de **nécropole seigneuriale**.
...
d'Aquitaine**, grand capitaine anglais de la guerre de Cent Ans. **Blessé** au
**pont de Lussac** le 31 déc. 1369 (coup de **Jacques de Saint-Martin**), il est
**transporté à Mortemer**, « la plus prochaine forteresse », où il meurt. **Froissart**
en fait l'une des plus belles pages de ses *Chroniques* — texte d'époque cité
...
### 9.1 Images téléchargées (`images/`) — libres (domaine public / CC)
Voir source et licence de chaque fichier dans [`CREDITS.md`](CREDITS.md).
...
Écrits d'époque : [`TEXTES-ET-ECRITS.md`](TEXTES-ET-ECRITS.md) · Crédits images :
[`CREDITS.md`](CREDITS.md) · Synthèse illustrée : `Morthemer-Recherche-Historique.pdf`.*
